            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    ...
                    let html = '<div class="chat">' +
                        ...
                        '<span class="avatar box-shadow-1 cursor-pointer">' +
                        '<img src="{{ asset('
                    images / profile / profile.jpg ') }}" alt="avatar" height="36" width="36"/>' +
                        '</span>' +
                        '</div>' +
                        '<div class="chat-body">' +
                        '<div class="chat-content">' +
