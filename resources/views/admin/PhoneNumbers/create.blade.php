                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('admin.phone-numbers.store') }}"
                                method="post">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" name="status" id="status">
                                                    <option value="available" {{ old('status') }}>
                                                        {{ __('locale.labels.available') }}</option>
                                                    <option value="assigned" {{ old('status') }}>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="select2-icons form-select" name="capabilities[]"
                                                    ...
                                                    <option value="sms" data-icon="message-square" selected>
                                                        {{ __('locale.labels.sms') }}</option>
                                                    <option value="voice" data-icon="phone-call">
                                                        {{ __('locale.labels.voice') }} </option>
                                                    <option value="mms" data-icon="image">{{ __('locale.labels.mms') }}
                                                    </option>
                                                    <option value="whatsapp" data-icon="message-circle">
                                                        {{ __('locale.labels.whatsapp') }} </option>
                                                    <option value="viber" data-icon="tablet">{{ __('locale.menu.Viber') }}
                                                    </option>
                                                    <option value="otp" data-icon="unlock">{{ __('locale.menu.OTP') }}
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="price"
                                                    ...
                                                    value="{{ old('price') ? old('price') : 0 }}" name="price" required
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" id="billing_cycle" name="billing_cycle">
                                                    <option value="monthly"
                                                        {{ old('billing_cycle') == 'monthly' ? 'selected' : null }}>
                                                        {{ __('locale.labels.monthly') }}</option>
                                                    <option value="daily"
                                                        {{ old('billing_cycle') == 'daily' ? 'selected' : null }}>
                                                        {{ __('locale.labels.daily') }}</option>
                                                    <option value="yearly"
                                                        {{ old('billing_cycle') == 'yearly' ? 'selected' : null }}>
                                                        {{ __('locale.labels.yearly') }}</option>
                                                    <option value="custom"
                                                        {{ old('billing_cycle') == 'custom' ? 'selected' : null }}>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="device_id"
                                                    ...
                                                    value="{{ old('device_id') ? old('device_id') : "Enter Device Id if using Websockets" }}" name="device_id" 
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select select2" id="sending_server_id"
                                                    ...
                                                    @foreach ($sending_servers as $sending_server)
                                                        <option value="{{ $sending_server->id }}">
                                                            {{ $sending_server->name }}
                                                            ({{ $sending_server->setting }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('currency_id')
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select select2" id="AI_SMS" name="AI_SMS">
                                                    <option value="0" selected>Select an Assistant</option>
                                                    @foreach($assistants as $assistant)
                                                        <option value="{{ $assistant['openAI_id'] }}">
                                                            {{ $assistant['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
