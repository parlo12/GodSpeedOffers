                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_WHGATE)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_NIMBUZ || $server['settings'] == SendingServer::TYPE_OZONESMS || $server['settings'] == SendingServer::TYPE_AMAZONSNS || $server['settings'] == SendingServer::TYPE_FAST2SMS || $server['settings'] == SendingServer::TYPE_SMSGATEWAYHUB || $server['settings'] == SendingServer::TYPE_SMSALA || $server['settings'] == SendingServer::TYPE_SPEEDAMOBILE)
