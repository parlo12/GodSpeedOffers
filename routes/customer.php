...
//top up payment
    ...
    */
    Route::prefix('chat-box')->name('chatbox.')->group(function () {
        ...
        Route::get('/search-chats', 'ChatBoxController@search_chats')->name('chats.search');
        Route::post('/sent', 'ChatBoxController@sent')->name('sent');
        Route::post('/{box}/messages', 'ChatBoxController@messages')->name('messages');
        Route::post('/{box}/additional_info', 'ChatBoxController@additional_info')->name('additional_info');
